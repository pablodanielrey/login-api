...
class HydraModel:
    ...
    def obtener_consent_challenge(self, challenge):
        ...
        """
        url = '{}/oauth2/auth/requests/consent?consent_challenge={}'.format(self.host, challenge)
        h = {
    ...
    def aceptar_consent_challenge(self, challenge, data):
        url = '{}/oauth2/auth/requests/consent/accept?consent_challenge={}'.format(self.host, challenge)
        h = {
            'X-Forwarded-Proto':'https',
    ...
    def denegar_consent_challenge(self, challenge):
        url = '{}/oauth2/auth/requests/consent/reject?consent_challenge={}'.format(self.host, challenge)
        data = {
            'error':'id_del_error',
    ...
    def obtener_login_challenge(self, challenge):
            ...
            retorno:
               {
                ...
                "client": {
                    ...
                    "client_uri": "string",
                    "contacts": ["string"],
                    "created_at": "2019-07-19T05:57:28Z",
                    ...
                    "tos_uri": "string",
                    "updated_at": "2019-07-19T05:57:28Z",
        ...
        """
        url = '{}/oauth2/auth/requests/login?login_challenge={}'.format(self.host, challenge)
        h = {
            'X-Forwarded-Proto':'https'
        }
        r = requests.get(url, headers=h, verify=self.verify, allow_redirects=False)
    ...
    def aceptar_login_challenge(self, challenge, data):
        url = '{}/oauth2/auth/requests/login/accept?login_challenge={}'.format(self.host, challenge)
        h = {
            'X-Forwarded-Proto':'https',
            'Content-Type': 'application/json'
        }
    ...
    def denegar_login_challenge(self, challenge, data):
        url = '{}/oauth2/auth/requests/login/reject?login_challenge={}'.format(self.host, challenge)
        h = {
            'X-Forwarded-Proto':'https',
            'Content-Type': 'application/json'
        }
